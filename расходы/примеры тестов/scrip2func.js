...
document.addEventListener('DOMContentLoaded', function () {
	...
	document.getElementById('check-btn').addEventListener('click', runMatchTest)
})
...
document.getElementById('check-btn').addEventListener('click', combineTests)
