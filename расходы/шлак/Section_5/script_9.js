function getResponse() {
	...
	var input6_1 = document.getElementById('input6_1')
	var input6_2 = document.getElementById('input6_2')
	var input6_3 = document.getElementById('input6_3')
	var input6_4 = document.getElementById('input6_4')

	var input7_1 = document.getElementById('input7_1')
	var input7_2 = document.getElementById('input7_2')
	var input7_3 = document.getElementById('input7_3')
	var input7_4 = document.getElementById('input7_4')

	var input8_1 = document.getElementById('input8_1')
	var input8_2 = document.getElementById('input8_2')
	var input8_3 = document.getElementById('input8_3')
	var input8_4 = document.getElementById('input8_4')

	var input9_1 = document.getElementById('input9_1')
	var input9_2 = document.getElementById('input9_2')
	var input9_3 = document.getElementById('input9_3')
	var input9_4 = document.getElementById('input9_4')

	var input10_1 = document.getElementById('input10_1')
	var input10_2 = document.getElementById('input10_2')
	var input10_3 = document.getElementById('input10_3')
	var input10_4 = document.getElementById('input10_4')
