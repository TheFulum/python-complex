function getResponse() {
	...
	if (
		input3_1.value ==
		'внутренняя организация программного обеспечения, включая различные компоненты и их взаимосвязи'
	) {
		//1
		rightRes++
		res3 = ' 3 - Верно'
	...
	if (input7_1.value == 'Ядро операционной системы ') {
		//1
		rightRes++
		res7 = ' 7 - Верно'
	}

	resultInPercents = (rightRes / 7) * 100
