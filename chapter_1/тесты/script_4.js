function checkAnswers() {
	...
	const q6Answers = document.querySelector('input[name="q1"]:checked')
	...
	const q5CorrectAnswer = 'ppl'
	const q5_2CorrectAnswer = 'Ppl'
	const q1CorrectAnswer = 'L'
	const q1_2CorrectAnswer = 'l'
	const q6CorrectAnswers = 'c'
	const q7CorrectAnswers = ['a', 'b', 'c']
	...
	if (q6Answers.value === q6CorrectAnswers) {
		correctCount++
	} else {
		incorrectCount++
